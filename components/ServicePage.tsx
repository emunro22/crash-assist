    ...
    <>
      ...
      <section className="relative pt-32 pb-20 bg-zinc-950 overflow-hidden">
        ...
        <div className="container relative z-10">
          ...
          >
            <Link href="/services" className="inline-flex items-center gap-2 text-zinc-500 hover:text-blue-500 text-sm mb-8 transition-colors">
              ...
              <div className="bg-zinc-900 border border-zinc-800 p-6">
                ...
                <ul className="space-y-2">
                  {[
                    ...
                    .map(s => (
                      <li key={s.slug}>
                        <Link href={`/services/${s.slug}`} className="text-zinc-400 hover:text-blue-500 text-sm transition-colors flex items-center gap-2">
