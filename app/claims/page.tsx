              ...
              <div className="grid grid-cols-2 gap-px bg-zinc-800">
                {[
                  ...
                  <div key={s.label} className="bg-zinc-950 p-6 text-center">
                    <div className="font-heading text-4xl font-black text-orange-500 leading-none">{s.value}</div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-px bg-zinc-800">
              {steps.map((s, i) => (
                <div key={s.step} className="bg-zinc-950 p-6 relative">
                  <div className="font-heading text-5xl font-black text-orange-500/20 leading-none mb-4">{s.step}</div>
                  ...
                  {i < steps.length - 1 && (
                    <div className="hidden lg:block absolute right-0 top-1/2 -translate-y-1/2 translate-x-1/2 w-4 h-4 bg-orange-500 rotate-45 z-10" />
                  )}
                </div>
              ))}
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12">
              <div>
                ...
                <h2 className="section-title mb-6">
                  Your<br />
                  <span className="text-orange-500">Entitlements</span>
                </h2>
